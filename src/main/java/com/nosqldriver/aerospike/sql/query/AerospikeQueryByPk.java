...
public class AerospikeQueryByPk extends AerospikeQuery<Key, QueryPolicy, Record> {
    public AerospikeQueryByPk(java.sql.Statement sqlStatement, String schema, List<DataColumn> columns, Key key, QueryPolicy policy, FunctionManager functionManager, boolean pk) {
        super(sqlStatement, schema, key.setName, columns, key, policy, functionManager, pk);
    }
