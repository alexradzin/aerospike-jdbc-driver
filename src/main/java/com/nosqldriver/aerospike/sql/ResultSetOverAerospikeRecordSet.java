...
public class ResultSetOverAerospikeRecordSet implements ResultSet {
    ...
    public ResultSetOverAerospikeRecordSet(Statement statement, String[] names, com.aerospike.client.query.RecordSet rs) {
    ...
    public String getString(String columnLabel) throws SQLException {
        return rs.getRecord().getString(columnLabel);
    }

    @Override
    public boolean getBoolean(String columnLabel) throws SQLException {
        return rs.getRecord().getBoolean(columnLabel);
    }

    @Override
    public byte getByte(String columnLabel) throws SQLException {
        return rs.getRecord().getByte(columnLabel);
    }

    @Override
    public short getShort(String columnLabel) throws SQLException {
        return rs.getRecord().getShort(columnLabel);
    }

    @Override
    public int getInt(String columnLabel) throws SQLException {
        return rs.getRecord().getInt(columnLabel);
    }

    @Override
    public long getLong(String columnLabel) throws SQLException {
        return rs.getRecord().getLong(columnLabel);
    }

    @Override
    public float getFloat(String columnLabel) throws SQLException {
        return rs.getRecord().getFloat(columnLabel);
    }

    @Override
    public double getDouble(String columnLabel) throws SQLException {
        return rs.getRecord().getDouble(columnLabel);
    }
    ...
    public byte[] getBytes(String columnLabel) throws SQLException {
        return (byte[])rs.getRecord().getValue(columnLabel);
    }
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        return new AerospikeResultSetMetaData();
    }
    ...
    public Object getObject(String columnLabel) throws SQLException {
        return rs.getRecord().getValue(columnLabel);
    }
    ...
    private <T> T getValue(String columnLabel, Function<Object, T> mapper) {
        return Optional.ofNullable(rs.getRecord().getValue(columnLabel)).map(mapper).orElse(null);
    }
