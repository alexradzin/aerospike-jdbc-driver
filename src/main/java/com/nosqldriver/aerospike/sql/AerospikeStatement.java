...
public class AerospikeStatement extends WarningsHolder implements java.sql.Statement, SimpleWrapper {
    ...
    protected enum StatementType implements Predicate<String> {
        ...
        CREATE_INDEX {
            ...
            int executeUpdate(AerospikeStatement statement, String sql) throws SQLException {
                ...
                AerospikeQueryFactory aqf = new AerospikeQueryFactory(statement, statement.schema.get(), statement.policyProvider, indexes, statement.cdm);
                aqf.createQueryPlan(sql);
    ...
    public AerospikeStatement(IAerospikeClient client, Connection connection, AtomicReference<String> schema, AerospikePolicyProvider policyProvider, CustomDeserializerManager deserializerManager) {
        this.client = client;
